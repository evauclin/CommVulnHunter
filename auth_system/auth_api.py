...
from .jwt_handler import (
    jwt_handler, SecurityHeaders, rate_limiter, 
    PasswordValidator, EmailValidator, audit_logger
)
...
async def change_password(
    ...
    if not auth_db.verify_password(password_data.current_password, user["password_hash"]):
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
